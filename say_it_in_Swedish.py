...
convert_mp3_to_wav("/Users/natalia/Documents/Projekt_programmering/upplastmening.mp3", "upplastmening_converted.wav")

#Function for comparison
def compare_and_feedback():

    #Uploading audio files for comparison
    y1, sr1 = librosa.load("upplastmening_converted.wav")
...
def cosine_similarity(x, y):
    ...
    return 1 - similarity  # Return distance (1 - similarity) for DTW
